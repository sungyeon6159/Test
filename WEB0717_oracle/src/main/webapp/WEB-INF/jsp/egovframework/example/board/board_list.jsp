<%--
  ...
  */
--%>
<%@page import="com.sewon.anyone.cmn.SearchVO"%>
...
/* 	
    ...
    //paging
    String url = "${hContext}/board/do_retrieve.do";
...
<head>
	...
	<!-- 부트스트랩 -->
	<link href="${hContext}/views/css/bootstrap.min.css"rel="stylesheet">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-12 text-right">
				<form:form commandName="boardVO" id="board_form" method="GET" class="mt-5 mb-5 login-input" name="board_form">
