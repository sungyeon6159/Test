						...
						<div class="card login-form mb-0">
							<div class="card-body pt-5">
								...
								<form:form commandName="searchVO" id="login_form" method="POST" class="mt-5 mb-5 login-input" name="login_form">
									...
									<button type="button" class="btn login-form__btn submit w-100"
										id="member_login" size="20">로그인</button>
									<p class="mt-5 login-form__footer" style="text-align: center">
										<a href="#" class="text-primary" onclick="idpassLookup();"> 아이디찾기 ㅣ 비밀번호 찾기</a>
										<a href="#" class="text-primary" onclick="javascript:goSignUp();"> ㅣ  회원가입 </a>
									</p>
								</form:form>
							</div>
						</div>
    ...
    ***********************************-->
	...
	<script type="text/javascript">
		function goRetrieve(id) {
			//console.log("----goRetrieve(id)------");
		
			if (id == 'admin' || id == 'ADMIN') {
				location.href = "${hContext}/admin/admin.jsp";
			} else {
				location.href = "${hContext}/admin/admin.jsp";
				//location.href = "${hContext}/admin/do_select_one.do";
			}
		}
		
		function idpassLookup() {
			console.log("----idpassLookup------");
		...
		function goSignUp(){
			...
			location.href="${hContext}/member/signup.do";
		};
