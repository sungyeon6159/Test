 ...
 */
package com.sewon.anyone.member.web;
...
public class UserController {
	...
	public String doSignUp(@ModelAttribute("signup") SampleDefaultVO searchVO, UserVO user, ModelMap model) throws Exception {

		LOGGER.debug("------doSignUp_Page-------");
		return "login/signUp";
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/member/resgister.do" , method = RequestMethod.GET, produces = "application/json; charset=UTF-8")
	@ResponseBody
	public String doResgister(@ModelAttribute("signup") SampleDefaultVO searchVO, HttpServletRequest req, UserVO user, ModelMap model) throws Exception {

		LOGGER.debug("------doResgister()-------");
...
//		LOGGER.debug("------getAttribute-------"+phone1);
		...
		//doInsert 쿼리
		int flag = this.userService.doInsert(user);
		LOGGER.debug("---AFTER--"+flag);
		if (1==flag) {
